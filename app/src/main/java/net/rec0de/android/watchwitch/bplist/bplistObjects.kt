...
class BPData(val byteLen: Int, val value: ByteArray) : BPListObject() {
    override fun toString() = "BPData(${value.hex()})"
}
data class BPAsciiString(val charCount: Int, val value: String) : BPListObject() {
    override fun toString() = value
}
data class BPUnicodeString(val charCount: Int, val value: String) : BPListObject() {
    override fun toString() = value
}
class BPUid(val byteLen: Int, val value: ByteArray) : BPListObject() {
